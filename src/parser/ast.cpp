...
std::shared_ptr<TypeDesc>
TypeDesc::makeName(const std::string& n)
{
  auto td = std::make_unique<TypeDesc>();
...
nodeKindName(NodeKind k)
{
  switch(k)
    ...
    case NodeKind::PROGRAM:
      return "Program";
    case NodeKind::TYPE_DEC:
      return "TypeDec";
    case NodeKind::VAR_DEC:
      return "VarDec";
    case NodeKind::PROC_DEC:
      return "ProcDec";
    case NodeKind::BASE_TYPE:
      return "BaseType";
    case NodeKind::ARRAY_TYPE:
      return "ArrayType";
    case NodeKind::REC_TYPE:
      return "RecType";
...
// 打印（调试用）────────────────────────────────────────────────────────
void
printAST(const ASTNode* node, int indent)
{
  if(!node)
    return;
